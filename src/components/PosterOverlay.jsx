  ...
  return (
    <div ref={slotRef} className="flex h-full w-full items-center justify-center overflow-hidden px-[1.5%] py-[0.8%]">
      <motion.span
        ...
        initial={{ filter: 'blur(12px) drop-shadow(0 0 8px rgba(196,181,253,0.42))' }}
        animate={{ filter: 'blur(0px) drop-shadow(0 0 10px rgba(255,255,255,0.72)) drop-shadow(0 0 22px rgba(168,85,247,0.55))' }}
